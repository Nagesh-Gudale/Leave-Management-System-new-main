...
$sql = "SELECT l.* , lt.type,u.full_name FROM leaves as l INNER JOIN leave_types as lt ON l.leave_type_id=lt.id INNER JOIN users as u ON l.user_id=u.id WHERE l.status='approved' And l.status1='pending'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['recordId'])) {
    ...
    $sql3 = "UPDATE leaves SET `status1` = '$new_value' WHERE id = '$id';";
